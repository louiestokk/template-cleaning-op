...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://images.pexels.com/photos/7464719/pexels-photo-7464719.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
        width: 1260,
        height: 750,
...
const KopaDodsbo = () => {
  const article = {
    ...
    image: "https://images.pexels.com/photos/7464719/pexels-photo-7464719.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    publisher: {
      "@type": "Organization",
      "name": "Tant Rut Alltjänsts",
      "logo": {
...
<ul style={{ marginTop: '20px' }}>
  ...
  <li style={{ fontSize: '0.85rem', lineHeight: '22px' }} className={styles.textform}>
    ...
    <DividerSection idsec={'koper-dodsbo-goteborg'} idone={'tomma-dodsbo-goteborg'}  imgUrl={'https://images.pexels.com/photos/7464719/pexels-photo-7464719.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} text={'När du behöver hjälp med att tömma ett dödsbo i Göteborg, erbjuder vi en komplett och smidig lösning från början till slut. På den dag vi tillsammans kommit överens om, kommer vi till platsen för att påbörja en noggrann sortering av dödsboet eller bohaget. Med omsorg och respekt går vi igenom alla föremål för att avgöra vad som kan doneras, återvinnas, eller tas till tippen. Efter att vi har hanterat allt som ska skänkas eller återvinnas, tar vi med oss det lösöre vi har köpt upp och transporterar det till vårt lager eller butik.'} service={'Dödsbo'} title={'Köper upp dödsbon i Göteborg'} secondTitle={'Tömmer dödsbo i Göteborg'}/>
    <LeftSection idtwo={'stadar-dodsbon-goteborg'} imgUrlsec={'https://images.pexels.com/photos/7464197/pexels-photo-7464197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} textsecond={'Behöver du hjälp med sanering och luktsanering av ett dödsbo i Göteborg? Vi erbjuder specialiserade saneringstjänster för dödsbon och arbetar omsorgsfullt för att återställa bostaden till ett rent och hygieniskt skick. Vårt erfarna team är utbildat i att hantera sanering av känsliga miljöer och förstår vikten av respekt och noggrannhet i varje steg.'} servicesec={'Dödsbo'} titlesecond={'Sanering av dödsbo i Göteborg'} bannerText={'Har du lösöre som du vill få värderat?'} service={'Dödsbo'} title={'Dödsbostädning i Göteborg'} text={'Att städa ett dödsbo kan vara en känslomässigt tung uppgift. Vi erbjuder därför en komplett tjänst för dödsbostädning i Göteborg som gör processen enklare för dig och din familj. Vår städning innefattar en noggrann och omsorgsfull hantering av bostaden, där varje moment utförs med respekt för det arbete och den omtanke som situationen kräver.'} imgUrl={'https://images.pexels.com/photos/7464708/pexels-photo-7464708.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'}/>
    <Tesimonial />
    <Divider text={'Helhetslösning för dödsbon och bohag'}/>
    <div className={styles.heroMain} id='stadning'>
    <article>
                <img alt={'dödsbo'} src={'https://images.pexels.com/photos/7464724/pexels-photo-7464724.jpeg?auto=compress&cs=tinysrgb&w=1200&lazy=load'} style={{width:'100%',height:'400px',objectFit:'contain'}}/>
     </article>
     <article >
     <article>
    ...
    <li style={{ fontSize: '0.85rem', lineHeight: '22px' }} className={styles.textform}>
     ...
     Vi erbjuder professionell värdering av dödsbon i Göteborg, inklusive tömning, städning och försäljning av föremål. Vi köper upp dödsbon i Göteborg och säljer vidare värdefulla objekt på ett effektivt sätt, samtidigt som vi ser till att tömma och städa bostaden. Vårt mål är att underlätta processen för anhöriga genom att ta hand om allt från värdering och bortforsling till slutstädning, med omtanke och respekt.
       ...
       <article id='vardera-dodsbo-goteborg'>
                <img alt={'värdering av dödsbo i Göteborg'} src={'https://images.pexels.com/photos/7464730/pexels-photo-7464730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} style={{width:'100%',height:'400px',objectFit:'contain'}}/>
     </article>
     </div>
    ...
    <article>
                <img alt={'dödsbo'} src={'https://images.pexels.com/photos/7464721/pexels-photo-7464721.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'} style={{width:'100%',height:'400px',objectFit:'contain'}}/>
     </article>
     <article>
     <article>
