...
const ClonFlyttComp = () => {
    ...
    const article = {
        ...
        "@type": "Article",
        title: `Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma`,
        description:`Behöver du hjälp med att flytta i ${currentCity}? Flyttströms ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`,
  ...
  return (
    <div>
             <title>{`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma`}</title>
    <meta name="description" content={`Behöver du hjälp med att flytta i ${currentCity}? Flyttströms ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
    <meta property="og:title" content={`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma`}/>
    <meta property="og:description" content={`Behöver du hjälp med att flytta i ${currentCity}? Flyttströms ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
    ...
    <meta name="twitter:title" content={`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma`}/>
    <meta name="twitter:description" content={`Behöver du hjälp med att flytta i ${currentCity}? Flyttströms ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
