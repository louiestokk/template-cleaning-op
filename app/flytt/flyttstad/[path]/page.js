...
const ClonFlyttComp = () => {
    ...
    const formateCity = () =>{
        const starteerr =    pathname.split('/flytt/flyttstad/flyttstad-')[1]
        switch (starteerr) {
            case 'goteborg':
...
<HeaderComp sidor={sidorflytt}/>
    ...
    <HeroComp title={`Flyttstäd i ${currentCity}`} text={`Vi flyttar, städar och tömmer hushåll och dödsbon i ${currentCity}. Nyttja din rut när du använder våra tjänster!`}/>
