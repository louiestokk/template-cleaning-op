...
const ClonFlyttComp = () => {
    ...
    const formateCity = () =>{
        const starteerr =    pathname.split('/flytthjalp/flyttfirma-')[1]
        switch (starteerr) {
            case 'goteborg':
    ...
    const article = {
        ...
        "@type": "Article",
        title: `Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma ${currentCity}`,
        description:`Behöver du hjälp med att flytta i ${currentCity}? TantRut Alltjänst ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`,
  ...
  return (
    <div>
             <title>{`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma ${currentCity}`}</title>
    <meta name="description" content={`Behöver du hjälp med att flytta i ${currentCity}? TantRut Alltjänst ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
    <meta property="og:title" content={`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma ${currentCity}`}/>
    <meta property="og:description" content={`Behöver du hjälp med att flytta i ${currentCity}? TantRut Alltjänst ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
    ...
    <meta name="twitter:title" content={`Flyttfirma i ${currentCity}? Trygg & Privärd Flyttfirma ${currentCity}`}/>
    <meta name="twitter:description" content={`Behöver du hjälp med att flytta i ${currentCity}? TantRut Alltjänst ger dig den bästa flytten i ${currentCity}! Prisvärd flyttfirma i ${currentCity}.`}/>
...
<HeaderComp sidor={sidorflytt}/>
    ...
    <HeroComp title={`Flyttfirma i ${currentCity}`} text={`Vi flyttar, städar och tömmer hushåll och dödsbon i ${currentCity}. Nyttja din rut när du använder våra tjänster!`}/>
