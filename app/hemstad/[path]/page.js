...
const ClonFlyttComp = () => {
    ...
    const formateCity = () =>{
        const starteerr =    pathname.split('/hemstad/hemstad-')[1]
        switch (starteerr) {
            case 'goteborg':
...
<HeaderComp sidor={sidorflytt}/>
    ...
    <HeroComp title={`Hemstäd i ${currentCity}`} text={`Vi flyttar, städar och tömmer hushåll och dödsbon i ${currentCity}. Nyttja din rut när du använder våra tjänster!`}/>
