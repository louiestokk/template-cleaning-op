...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://tantrut.netlify.app/stadar-dodsbon-goteborg',
    languages: {
      'sv': '/sv',
    },
  },
  openGraph: {
    ...
    description:'Behöver ni städa ett dödsbo i Göteborg? Vi städar dödsbon och bohag i Göteborg. Köpa upp, tömma och städa dödsbo i Göteborg',
    url: 'https://tantrut.netlify.app/stadar-dodsbon-goteborg',
...
<HeaderComp sidor={sidorsalja}/>
    ...
    <HeroComp title={'Städa dödsbo i Göteborg'} text={'Vi köper upp, städar och tömmer hushåll och dödsbon i Göteborg. Nyttja din rut när du använder våra tjänster!'}/>
